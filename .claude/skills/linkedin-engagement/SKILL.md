...
description: LinkedIn Content-Erstellung, Engagement und Monitoring. Regionale Anpassung (US/EU/Asien), Artikel mit Teasern, Bildgenerierung via Gemini, Kommentar-Monitoring. Vorlage — Konfiguration unter "Konfiguration" und "Persona" vor Nutzung ausfüllen.
...
**LinkedIn-Profil:** [DEIN LINKEDIN-PROFIL, z.B. linkedin.com/in/dein-handle]
**Unternehmen:** Balero Creativo
**Fokus:** [DEINE KERNTHEMEN, z.B. Branding, Design, kreative Strategie]

**Ziel-Regionen:**
- **Primär:** [z.B. LATAM, España]
- **Sekundär:** [z.B. USA, EU]
- **Tertiär:** [optional weitere Märkte]

**Fokus-Hashtags:**
- ES: #Branding #DiseñoGráfico #IdentidadVisual #Marketing #Creatividad
- EN: #Branding #GraphicDesign #VisualIdentity #CreativeAgency #Design

> Passe Profil, Fokus, Regionen und Hashtags an deine tatsächliche Marke an, bevor du die Slash-Commands nutzt.
...
**Workflow:**
1. Durchsuche Hashtags: #Branding, #GraphicDesign, #VisualIdentity, #Creatividad
...
**Optimierte Prompts für Branding/Design-Content:**
```
"Clean, professional infographic showing [TOPIC].
Modern flat design, blue and white color scheme,
minimal text, branding/creative-agency context.
...
#Branding #Design #CreativeAgency #VisualIdentity
```
...
- Hot Takes: "Unpopular opinion: most brands don't need a rebrand, they need consistency"
...
#Branding #Design #IdentidadVisual #Marketing #Creatividad
```
...
#Branding #Design #CreativeAgency
```
...
```
I'm thrilled to announce our new brand identity system!

Here are 5 key takeaways:

Punkt 1 Consistent visual language
Punkt 2 23% higher recall in testing
Punkt 3 Data-driven design decisions
Punkt 4 Seamless rollout across channels
Punkt 5 Team empowerment

This truly changed everything for us. What's your experience with rebranding?

#Branding #Design #VisualIdentity #CreativeAgency #Marketing
```

**Menschlich geschrieben (GUT):**
```
Letzte Woche endlich unser neues Brand-Guideline-System live geschaltet.

Ehrlich gesagt war der Weg dahin holprig - erste Version war zu kompliziert, keiner hat sie benutzt. Jetzt simpler und das Team hält sich tatsächlich dran.

Deutlich weniger Inkonsistenzen seit dem. Ob das so bleibt weiß ich nicht, Anfangs-Effekt vielleicht

Was mich interessiert: wie kriegt ihr euer Team dazu, Brand-Guidelines wirklich zu nutzen.

#Branding #Design #IdentidadVisual
```
...
5. Zeitliche Einordnung - "Letzte Woche bei einem Kunden-Projekt..."
...
| Reichweite | Hashtags |
|------------|----------|
| Hoch (>100k) | #Branding #Marketing #Diseño |
| Mittel (10-100k) | #DiseñoGráfico #IdentidadVisual #Creatividad |
...
| Reichweite | Hashtags |
|------------|----------|
| Hoch (>500k) | #Branding #Marketing #Design |
| Mittel (50-500k) | #GraphicDesign #VisualIdentity #CreativeAgency |
| Nische (<50k) | #BrandStrategy #DesignThinking #CreativeProcess |
...
### Beispiel:
```
85% der Rebranding-Projekte liefern nicht den erwarteten Impact.

Wir haben 12 Projekte analysiert und die 3 häufigsten Fehler identifiziert.

Im Artikel: Konkrete Learnings und wie ihr sie vermeidet 👇
...
**Infografik (Branding-Prozess/Daten):**
```
Professional infographic showing a brand identity process breakdown.
Clean flat design, blue (#0077B5 LinkedIn blue) and white.
Icons for Discovery, Design, Delivery.
...
**Header für Artikel:**
```
Modern creative-agency workspace abstract visualization.
...
Blue and white, professional B2B branding/creative agency.
...
**LinkedIn-Profil:**
- Name: [Dein Name]
- Position: [Deine Rolle bei Balero Creativo]
- Standort: [Deine Stadt/Region]
- Hintergrund: [Deine fachliche Expertise, z.B. Branding/Design]

**Authentizitäts-Elemente:**
- [Persönliche Details, sparsam erwähnen - z.B. Arbeitsweise, Alltag]
- Praktische Erfahrung aus echten Projekten
- [Regionale/kulturelle Perspektive]
- Kritisch gegenüber Hype, pragmatisch

**Schreibstil LinkedIn:**
- Professioneller als Reddit, aber nicht steif
- [Sprache je nach Zielgruppe, z.B. Spanisch/Englisch]
...
3. navigate (url: "https://www.linkedin.com/feed/hashtag/branding")
   → Hashtag-Feed öffnen
...
```
1. navigate (url: "https://www.linkedin.com/in/[DEIN-HANDLE]/recent-activity/")
...
url: "https://www.linkedin.com/feed/hashtag/branding"
```
...
- [ ] Authentische Stimme (deine Persona)?
