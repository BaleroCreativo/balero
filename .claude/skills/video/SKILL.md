<!--
Skill original: video, Corey Haines (https://github.com/coreyhaines31/marketingskills/tree/main/skills/video)
...
| **Editing/Repurposing** | Cutting long-form into short clips | Descript, Opus Clip, CapCut | Podcast/webinar to social clips |
...
| **Hunyuan Video / Wan 2** | 720p to 1080p | Variable | Open-source self-hosted; full control, no API fees | Free (GPU) |
...
- **Storyboard to video workflow**: Runway, LTX Studio
...
|----------|:---:|-------------|
| Recurring content (weekly updates) | Yes | n/a |
| Multilingual versions | Yes | n/a |
| Personalized outreach at scale | Yes | n/a |
